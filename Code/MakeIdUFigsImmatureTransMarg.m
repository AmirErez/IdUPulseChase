...
%% Import
dirname = '../Data/';
savefile = [dirname 'RawImmTransMarg'];
Cols = 'brg';
Markers = 'os^'; 
...
%% Stability analysis
tabStability = readtable('../Data/RawImmTransMarg/StabilityImmTransMarg.csv');

tabStability = join(expdata.tabSamples,tabStability);

figname = 'ImmTransMargStability';
...
%     CoarseGrid = struct;
CoarseGrid.xchan = 'Er168Di_168Er_CD21';
CoarseGrid.xchanName = 'CD21';
CoarseGrid.ychan = 'Gd158Di_158Gd_CD93';
CoarseGrid.ychanName = 'CD93';
...
Gates.Ranges = [10.^[0 2];10.^[0 2]]; % Not bad fit
    
           

figname = 'ImmatureTransMargGating';
...
figname = 'ImmatureTransMargTimeseries';
% newfigure(figname,7,2);
...
figname = 'ImmatureTransMargPeakTimeBoxPlot';
...
figname = 'ImmatureTransMargTimeseriesFit';
% newfigure(figname,7,2);
